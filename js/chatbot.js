...
function contactDetailsTabShow(){
  ...
  const typeMessage = document.createElement("div");
  typeMessage.className = "typemessage-container";
  typeMessage.innerHTML = `<div class="chatbot-sagation-message"><div class="chatbot-details-btn-container"><button class="border-0 rounded-1" onclick="aboutBtn()">About Us </button><button class="border-0 rounded-1" onclick="serviceTab()">Services </button> <button  class="border-0 rounded-1" onclick="IndustriesTabShow()">Industries</button> <button  class="border-0 rounded-1" onclick="productTabShow()">Products</button> <button  class="border-0 rounded-1" onclick="careersShow()">Careers</button></div><div class="type-message-content">${currentMessageTime}</div></div>`;
  chatbotContent.appendChild(typeMessage);
  },1010)
}
  ...
  setTimeout(() => {
    ...
    aboutTab.innerHTML = `
      <div class="chatbot-reply-icon"><img src="images/message-chatbot-icon2.png" alt="message-cion"></div><div><div class="reply-message-content">
        <p><b><a href="blockchain" target="_blank" class="chatbot-links">Blockchain</a></b> services assist businesses in adopting distributed ledger technology (DLT) 
...
function IndustriesDetailsTabShow(){
  ...
  getCurrentMessageTime()
   setTimeout(() => {
    ...
    aboutTab.innerHTML = `
  <div class="chatbot-details-btn-container"><button onclick="window.open('oil-gas-and-power', '_blank', 'noopener,noreferrer')">Oil, Gas, and Power</button><button onclick="window.open('banking-financial-services-and-insurance', '_blank', 'noopener,noreferrer')">Banking, Financial Services, and Insurance</button><button onclick="window.open('homeland-security-and-defense', '_blank', 'noopener,noreferrer')">Homeland Security and Defence</button><button onclick="window.open('transport-and-logistics', '_blank', 'noopener,noreferrer')">Transport and Logistics</button><button onclick="window.open('telecom', '_blank', 'noopener,noreferrer')">Telecom</button><button onclick="window.open('healthcare', '_blank', 'noopener,noreferrer')">Healthcare</button><button onclick="window.open('agriculture', '_blank', 'noopener,noreferrer')">Agriculture</button><button onclick="window.open('education', '_blank', 'noopener,noreferrer')">Education</button><button onclick="window.open('critical-it-and-urban-infrastructure', '_blank', 'noopener,noreferrer')">Critical IT and Urban Infrastructure</button><button onclick="window.open('solid-waste-management', '_blank', 'noopener,noreferrer')">Solid Waste Management</button></div><div class="type-message-time">${currentMessageTime}</div>
  </div></div>`;
    chatbotContent.appendChild(aboutTab);
    chatbotContent.scrollTo({
      top: chatbotContent.scrollHeight,
...
function intelligentDebriefingAnalyticsTabShow() {
  ...
  setTimeout(() => {
    ...
    aboutTab.innerHTML = `
  <div class="chatbot-reply-icon"><img src="images/message-chatbot-icon2.png" alt="message-cion"></div>
    <div><div class="reply-message-content">The <b><a href="intelligent-debriefing-with-analytics-ida" target="_blank" class="chatbot-links">Intelligent Debriefing with Analytics (IDA)</a></b> platform is a proprietary, AI/ML-powered solution designed for intelligent incident management in mission-critical environments. It functions as a strategic command center by aggregating and analyzing fragmented multi-source data (including social media) into a single, encrypted, real-time intelligence report. The platform leverages predictive analytics to forecast potential threats, monitors compliance with Standard Operating Procedures (SOPs), and continuously refines its intelligence to enable faster response, smarter decision-making, and enhanced accountability during security or disaster events.
...
function projectManagementSystemTabShow() {
  ...
  setTimeout(() => {
    ...
    aboutTab.className = "reply-message-container";
    aboutTab.innerHTML = `
 <div class="chatbot-reply-icon"><img src="images/message-chatbot-icon2.png" alt="message-cion"></div> <div><div class="reply-message-content">The <b><a href="project-process-management-system" target="_blank" class="chatbot-links">Project Process Management System (PPMS)</a></b> is a proprietary, next-generation platform for digitizing and managing complex project lifecycles from concept to closure. It provides total control and transparency by digitizing every phase, including DPR approval, tendering, milestone tracking, and billing. Leveraging AI/ML and GIS-Based Visualization, PPMS offers real-time dashboards to track progress, predict potential delays/bottlenecks, enforce SOPs, and manage the entire vendor lifecycle, ensuring traceability and accountability across departments and geographies.</div><div class="reply-message-time">${currentMessageTime}</div></div>
    `;
    chatbotContent.appendChild(aboutTab);
    // scroll to bottom after adding the reply
    chatbotContent.scrollTo({

    ...
    !(function (e) {
        ...
        e(".fullwidth-slideshow").owlCarousel({
            ...
            afterAction: function (a) {
                ...
                e(".fullwidth-slideshow-pager").find(".owl-item").removeClass("synced").eq(i).addClass("synced"),
                    void 0 !== e(".fullwidth-slideshow-pager").data("owlCarousel") &&
                        (function (e) {
                            var a = t.data("owlCarousel").owl.visibleItems,
                                i = e,
                                s = !1;
                            for (var l in a) if (i === a[l]) s = !0;
                            !1 === s
                                ? i > a[a.length - 1]
                                    ? t.trigger("owl.goTo", i - a.length + 2)
                                    : (i - 1 == -1 && (i = 0), t.trigger("owl.goTo", i))
                                : i === a[a.length - 1]
                                  ? t.trigger("owl.goTo", a[1])
                                  : i === a[0] && t.trigger("owl.goTo", i - 1);
                        })(i);
            },
            ...
            e(".fullwidth-slideshow-pager").on("click", ".owl-item", function (t) {
                t.preventDefault();
                var i = e(this).data("owlItem");
                a.trigger("owl.goTo", i);
            });
        var i = e(".fullwidth-slideshow").data("owlCarousel");
        e(document.documentElement).keyup(function (e) {
            37 == e.keyCode ? i.prev() : 39 == e.keyCode && i.next();
        }),
            e(".owl-carousel").length && (i = e(".owl-carousel").data("owlCarousel")).reinit();
    })(jQuery);
}
!(function (e) {
    "use strict";
    ...
    e(window).load(function () {
        if (
            ...
            initWorkFilter(),
            (function () {
                e(".local-scroll").localScroll({ target: "body", duration: 1500, offset: 0, easing: "easeInOutExpo" });
                var a = e(".home-section, .split-section, .page-section"),
                    t = e(".scroll-nav li a");
                e(window).scroll(function () {
                    a.filter(":in-viewport:first").each(function () {
                        var a = e(this),
                            i = e('.scroll-nav li a[href="#' + a.attr("id") + '"]');
        ...
        e(document).ready(function () {
            ...
            e(window).bind("scroll", function (s) {
                e(window).scrollTop() > a.height() ? i() : t();
            });
            var t = function () {
                    a.css("position", "relative"), a.css("margin-top", "0px");
                },
                i = function () {
                    a.css("position", "fixed"), a.css("top", "0"), a.css("margin-top", "70px");
                };
        }),
        e(document).ready(function () {
            e(window).trigger("resize"),
                (function () {
                    e(".js-stick").sticky({ topSpacing: 0 }),
                        i(e(".inner-nav > ul > li > a"), e(".main-nav")),
                        i(s, e(".main-nav")),
                        ...
                        e(window).scroll(function () {
                            e(window).scrollTop() > 10
                                ? (e(".js-transparent").removeClass("transparent"),
                                  e(".main-nav, .nav-logo-wrap .logo, .mobile-nav").addClass("small-height"))
                                : (e(".js-transparent").addClass("transparent"),
                                  e(".main-nav, .nav-logo-wrap .logo, .mobile-nav").removeClass("small-height"));
                        }),
                        s.click(function () {
                            l.hasClass("js-opened")
                                ...
                                : (l.slideDown("slow", "easeOutQuart").addClass("js-opened"),
                                  ...
                                  e(".main-nav").hasClass("not-top") && e(window).scrollTo(".main-nav", "slow"));
                        }),
                        l.find("a:not(.mn-has-sub)").click(function () {
                            s.hasClass("active") &&
                                (l.slideUp("slow", "easeOutExpo").removeClass("js-opened"), s.removeClass("active"));
                        });
                    var a,
                        t = e(".mn-has-sub");
                    e(".mobile-on .mn-has-sub")
                        ...
                        (a = t.parent("li")).hover(
                            ...
                            function () {
                                e(".main-nav").hasClass("mobile-on") ||
                                    e(this).find(".mn-sub:first").stop(!0, !0).delay(100).fadeOut("fast");
                            }
                        );
                })(),
                init_fullscreen_menu(),
                init_side_panel(),
                e(".work-lightbox-link").magnificPopup({ gallery: { enabled: !0 }, mainClass: "mfp-fade" }),
                ...
                (function () {
                    ...
                    e(".tpl-minimal-tabs > li > a").click(function () {
                        e(this).parent("li").hasClass("active") ||
                            ((a = e(".tpl-minimal-tabs-cont > .tab-pane").filter(e(this).attr("href")).height()),
                        ...
                        e(".accordion").each(function () {
                            ...
                            e(this).children("dd").first().slideDown("easeOutExpo"),
                                ...
                                e(this)
                                    ...
                                    .children("a")
                                    .click(function () {
                                        var t = e(this).parent().next("dd");
                                        return (
                                            e(".accordion > dt > a").removeClass("active"),
                                            e(this).addClass("active"),
                                            a.not(t).slideUp("easeInExpo"),
                        ...
                        e(".toggle > dt > a").click(function () {
                            return (
                                e(this).hasClass("active")
                                    ? (e(this).parent().next().slideUp("easeOutExpo"), e(this).removeClass("active"))
                ...
                e(".tooltip-bot, .tooltip-bot a, .nav-social-links a").tooltip({ placement: "bottom" }),
        ...
        e(window).resize(function () {
            e(".mobile-on .desktop-nav > ul").css(
                ...
                e(window).width() <= 1024
                    ...
                    : e(window).width() > 1024 && (e(".main-nav").removeClass("mobile-on"), l.show()),
    ...
    fm_menu_button.click(function () {
        return (
            ...
            ($(this).hasClass("active")
                ...
                : ($(".owl-carousel").lenth && $(".owl-carousel").data("owlCarousel").stop(),
    ...
    !(function (e) {
        ...
        sp_button.click(function () {
            return (
                ...
                e(".owl-carousel").lenth && e(".owl-carousel").data("owlCarousel").stop(),
                !1
            );
        }),
        ...
        (a = work_grid.hasClass("masonry") ? "masonry" : "fitRows"),
            e(".filter").click(function () {
                return (
                    ...
                    work_grid.imagesLoaded(function () {
                        work_grid.isotope({ itemSelector: ".mix", layoutMode: a, filter: fselector });
                    }),
                    !1
                );
            }),
            window.location.hash &&
                e(".filter").each(function () {
                    e(this).attr("data-filter") == "." + window.location.hash.replace("#", "") &&
...
function init_wow() {
    var e, a;
    (e = jQuery),
        (a = new WOW({ boxClass: "wow", animateClass: "animated", offset: 90, mobile: !1, live: !0 })),
...
$(document).ready(function () {
    var e = document.querySelector("#testimonialCarousel");
    if (window.matchMedia("(min-width: 576px)").matches) {
        var a = new bootstrap.Carousel(e, { interval: !1 }),
            t = $(".carousel-inner"),
            i = t[0].scrollWidth,
            s = $(".carousel-item").width(),
            l = 0,
            o = ($(".carousel-item").length, $(".carousel-item").clone(!0));
        function n() {
            (l += s) >= i / 2 && (t.scrollLeft(0), (l = s)), t.animate({ scrollLeft: l }, 400);
        }
        t.append(o), (i = t[0].scrollWidth) / 2 - 3 * s;
        var r = setInterval(n, 9e3);
        $(".testimonial-slider").hover(function () {
            ...
            $("#prevArrow").on("click", function () {
                clearInterval(r),
                    (l -= s) < 0 && (t.scrollLeft(i / 2 - s), (l = i / 2 - 2 * s)),
                    t.animate({ scrollLeft: l }, 400);
            });
    } else {
        $(e).addClass("slide");
        a = new bootstrap.Carousel(e, { interval: 9e3, wrap: !0 });
        $("#nextArrow").on("click", function () {
            a.next();
        }),
            $("#prevArrow").on("click", function () {
...
// -------layout-shifting-issue-resolved-------
